...
SRC = main.c
SRC += lexer/lexer.c lexer/lexer_token.c lexer/lexer_env.c lexer/lexer_utils.c lexer/string.c
SRC += utils/error.c utils/exit.c utils/free.c utils/init.c utils/signal.c utils/utils.c
